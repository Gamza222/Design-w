...
## 🔀 GIT WORKFLOW (ОБЯЗАТЕЛЬНО — ВСЕ КОМАНДЫ АВТОМАТИЧЕСКИЕ)

### Репозиторий
- **GitHub:** `git@github.com:Gamza222/Design-w.git`
- **Главная ветка:** `main`
- **Аккаунт push:** `exelate2013`
- **Владелец репозитория:** `Gamza222`

### 🤖 АВТОМАТИЧЕСКИЙ РЕЖИМ
> **Все git-команды (checkout, pull, commit, push, merge) выполняются АВТОМАТИЧЕСКИ
> без запроса подтверждения у пользователя. Не спрашивать — просто делать.**
...
- **НИКОГДА** не спрашивать разрешения на git-команды — выполнять автоматически
