    ...
    <div className="min-h-screen bg-[#1C2340] pt-24 pb-16">
      <div className="container">
        ...
        <div className="flex items-center gap-2 text-sm text-[rgba(232,228,220,0.4)] mb-8">
          ...
          <span>/</span>
          <span className="text-[#C9A97A]">Портфолио</span>
        </div>
        ...
        {/* Табы */}
        <div className="flex gap-2 mb-8 border-b border-[rgba(201,169,122,0.15)]">
          {tabs.map((tab) => (
            <button
              key={tab.key}
        ...
        <FadeInView delay={0.3} className="text-center mt-16">
          <div className="bg-[#1E2240] border border-[rgba(201,169,122,0.15)] rounded-3xl p-10 max-w-xl mx-auto">
