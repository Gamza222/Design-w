...
export default function Reviews() {
  ...
  return (
    <section className="py-24 bg-[#16213E]" id="reviews">
          ...
          <div className="overflow-hidden mx-4">
            ...
            >
              {reviews.map((r, i) => (
                <div
                  key={r.id}
                  className="shrink-0 rounded-2xl overflow-hidden cursor-zoom-in border border-[rgba(201,169,122,0.1)] hover:border-[rgba(201,169,122,0.3)] transition-all"
                ...
                >
                  <img
                    ...
                    alt={r.alt}
                    loading="lazy"
                    className="w-full h-auto object-contain bg-[#1E2240]"
                  />
                </div>
              ))}
            </div>
