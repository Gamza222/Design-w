...
export default function Hero() {
  ...
  const overlayOpacity = useTransform(scrollYProgress, [0, 0.6], [0.82, 0.97])
  const contentY = useTransform(scrollYProgress, [0, 1], ['0%', '15%'])

  const stats = [
    { num: '10 000+', label: 'выполненных проектов' },
    { num: '5 лет', label: 'на рынке с 2020 года' },
  ...
  return (
    ...
    >
      ...
      {/* Оверлей — затемняется при скролле */}
      <motion.div
        className="absolute inset-0 bg-gradient-to-br from-[#1A1A2E] via-[#1A1A2E] to-[#16213E]"
        style={{ opacity: overlayOpacity }}
      />

      {/* Декоративные блюр-орбы */}
      <div className="absolute top-1/4 right-0 w-[600px] h-[600px] bg-[#C9A97A]/8 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 left-[-100px] w-[400px] h-[400px] bg-[#16213E]/60 rounded-full blur-[80px] pointer-events-none" />

      {/* Контент — лёгкий параллакс вверх */}
      <motion.div className="container relative z-10" style={{ y: contentY }}>
        ...
        >
          Студия дизайна интерьера с 2020 года
        </motion.p>

        <motion.h1
          className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#E8E4DC] leading-tight mb-6 max-w-3xl"
        ...
        >
          ...
          именно таким, каким вы его представляете. Напишите нам и мы покажем ориентировочную
